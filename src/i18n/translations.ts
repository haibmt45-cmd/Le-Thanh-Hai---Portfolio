export const translations = {
  vi: {
    ...
    vgg: {
      ...
      key_result_p1: 'Trực tiếp thực hiện quay dựng hơn 15 - 20 video ngắn, làm chủ thiết bị và ánh sáng hiện trường để đảm bảo chất lượng khung hình đạt chuẩn điện ảnh. Tối ưu quy trình ghi hình thực tế giúp giảm thiểu sai sót và giữ tính nhất quán từ tiền kỳ đến hậu kỳ.',
      ...
      key_result_p3: 'Ứng dụng các công cụ AI vào quy trình sáng tạo, từ khâu lên kịch bản, ý tưởng đến tối ưu hoá nội dung. Giảm thiểu 30% thời gian nghiên cứu và sản xuất nội dung, đồng thời vẫn đảm bảo tính mới mẻ và đúng insight khách hàng.',
      key_result_p4: 'Theo dõi, quản lý và tối ưu hoá các chỉ số trên Fanpage. Đảm bảo tần suất nội dung ổn định với 3 - 5 bài/tuần, góp phần trực tiếp vào việc duy trì tương tác tự nhiên và xây dựng uy tín thương hiệu trong mắt đối tác.',
