export const translations = {
  ...
  en: {
    ...
    vgg: {
      ...
      key_result_label: 'KEY RESULT',
      key_result_p1: 'Ensuring cinematic frame quality through mastery of equipment and on-site lighting. Optimizing actual filming workflows, ensuring consistency from pre-production to post-production.',
